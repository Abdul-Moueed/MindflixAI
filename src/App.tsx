...
// ─── 15-movie library — verified TMDB image paths ────────────────────────
const FB_MOVIES = [
  {
    id:'fl-1', title:'Interstellar', year:2014, genre:'Sci-Fi / Adventure',
    traits:['intellectual','melancholy'], badge:'Cosmic Odyssey',
    ...
    reason:'Matches your desire for existential grandeur and cosmic emotional connection.',
  },
  {
    id:'fl-2', title:'Blade Runner 2049', year:2017, genre:'Sci-Fi / Cyberpunk',
    traits:['intellectual','dark','melancholy'], badge:'Neon Noir',
    synopsis:'A blade runner unearths a long-buried secret that could destabilise society.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BNzA1Njg4NzYxOV5BMl5BanBnXkFtZTgwODk5NjU3MzI@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/3/33/Blade_Runner_2049.png',
    ...
    reason:'Perfect for a moody state craving atmospheric immersion.',
  },
  {
    id:'fl-3', title:'Mad Max: Fury Road', year:2015, genre:'Action / Sci-Fi',
    traits:['action','dark'], badge:'High-Octane Thrill',
    synopsis:'A woman rebels against a tyrannical ruler in a post-apocalyptic wasteland.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg',
    ...
    reason:'Delivers relentless adrenaline for a high-intensity mood.',
  },
  {
    id:'fl-4', title:'The Dark Knight', year:2008, genre:'Action / Crime',
    traits:['action','dark','mindbend'], badge:'Crime Masterpiece',
    synopsis:'Batman faces the Joker — a criminal genius who plunges Gotham into anarchy.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/8/8a/Dark_Knight.jpg',
    voteAverage:9.0, duration:'2h 32m', director:'Christopher Nolan',
    cast:['Christian Bale','Heath Ledger'],
    trailerUrl:'https://www.youtube.com/watch?v=EXeTwQWrcwY',
    reason:'Satisfies complex psychological tension and high-stakes moral drama.',
  },
  {
    id:'fl-5', title:'Her', year:2013, genre:'Romance / Sci-Fi',
    traits:['romance','melancholy','cozy'], badge:'Bittersweet Romance',
    synopsis:'A lonely writer develops a deep relationship with an AI operating system.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMjA1Nzk0OTM2OF5BMl5BanBnXkFtZTgwNjU2NjEwMDE@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/4/44/Her2013Poster.jpg',
    ...
    reason:'Resonates with longing for emotional warmth and near-future nostalgia.',
  },
  {
    id:'fl-6', title:'Spirited Away', year:2001, genre:'Animation / Fantasy',
    traits:['cozy','fun'], badge:'Whimsical Masterpiece',
    synopsis:'A young girl wanders into a world ruled by gods and spirits and must find a way home.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMjlmZmI5MDctNDE2YS00YWE0LWE5ZWItZDBhYWQ0NjNkMWFhXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/d/db/Spirited_Away_Japanese_poster.png',
    voteAverage:8.6, duration:'2h 05m', director:'Hayao Miyazaki',
    cast:['Daveigh Chase','Suzanne Pleshette'],
    trailerUrl:'https://www.youtube.com/watch?v=ByXuk9QqQkk',
    reason:'Pure magical enchantment for a heart seeking imaginative wonder.',
  },
  {
    id:'fl-7', title:'Inception', year:2010, genre:'Sci-Fi / Action',
    traits:['mindbend','action','intellectual'], badge:'Mind-Bending Heist',
    synopsis:'A thief who steals corporate secrets through dream-sharing is given the inverse task.',
    ...
    reason:'Engages analytical curiosity with multi-layered dream logic.',
  },
  {
    id:'fl-8', title:'Parasite', year:2019, genre:'Thriller / Drama',
    traits:['dark','mindbend'], badge:"Palme d'Or Winner",
    synopsis:'Greed and class discrimination threaten the symbiotic relationship between two families.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BYWZjMjk3ZTItODQ2ZC00NTY0LWE2ZTgtOTY3ZTZkMWViOWI3XkEyXkFqcGdeQXVyODk4OTc3MTY@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/5/53/Parasite_%282019_film%29.png',
    voteAverage:8.5, duration:'2h 12m', director:'Bong Joon Ho',
    cast:['Song Kang-ho','Lee Sun-kyun'],
    trailerUrl:'https://www.youtube.com/watch?v=5xH0HfJHsaY',
    reason:'Razor-sharp social commentary with unpredictable twists.',
  },
  {
    id:'fl-9', title:'Spider-Man: Across the Spider-Verse', year:2023, genre:'Animation / Action',
    traits:['fun','action'], badge:'Visual Wonder',
    synopsis:'Miles Morales catapults across the Multiverse encountering a team of Spider-People.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMzI0NmVkMjEtYmY4MS00ZDMxLTlkZmEtMzU4MDQxYTMzMjU2XkEyXkFqcGdeQXVyMzQ0MzA0NTM@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/b/b4/Spider-Man-_Across_the_Spider-Verse_poster.jpg',
    voteAverage:8.7, duration:'2h 20m', director:'Joaquim Dos Santos',
    cast:['Shameik Moore','Hailee Steinfeld'],
    trailerUrl:'https://www.youtube.com/watch?v=cqGjhVJWtEg',
    reason:'Groundbreaking artistry, fast-paced energy, and heartfelt bonds.',
  },
  {
    id:'fl-10', title:'Shutter Island', year:2010, genre:'Mystery / Thriller',
    traits:['mindbend','dark'], badge:'Psychological Thriller',
    synopsis:'A US Marshal investigates the disappearance of a murderer from a hospital for the criminally insane.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BYzhiNDkyNzktNTZmYS00ZTQ3LWI1ZjUtNGVlMTAxNWQ2NjdjXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/4/4d/Shutterislandposter.jpg',
    ...
    reason:'Eerie, haunting atmospheric puzzle that keeps your mind guessing.',
  },
  {
    id:'fl-11', title:'La La Land', year:2016, genre:'Romance / Drama',
    traits:['romance','cozy','melancholy'], badge:'Vibrant & Bittersweet',
    ...
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/a/ab/La_La_Land_%28film%29.png',
  ...
  {
    id:'fl-12', title:'Get Out', year:2017, genre:'Horror / Thriller',
    traits:['dark','mindbend'], badge:'Social Horror',
    synopsis:"A young man visits his girlfriend's family and makes disturbing discoveries.",
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMjUxMDQwNjcyNl5BMl5BanBnXkFtZTgwNzcwMzc1MTI@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/a/a8/Get_Out_poster.png',
    ...
    reason:'Brilliantly crafted psychological horror with a shocking revelation.',
  },
  {
    id:'fl-13', title:'Moonlight', year:2016, genre:'Drama',
    traits:['melancholy','romance'], badge:'Oscar Best Picture',
    synopsis:"A young man's journey of self-discovery across three defining chapters of his life.",
    imageUrl:'https://m.media-amazon.com/images/M/MV5BNzQxNTIyODAxMV5BMl5BanBnXkFtZTgwNzQyMDA3OTE@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/b/b2/Moonlight_%282016_film%29.png',
  ...
  {
    id:'fl-14', title:'Jojo Rabbit', year:2019, genre:'Comedy / Drama',
    traits:['cozy','fun','melancholy'], badge:'Heartwarming Comedy',
    synopsis:"A boy in WWII Germany befriends a Jewish girl hiding in his mother's attic.",
    imageUrl:'https://m.media-amazon.com/images/M/MV5BNzY2NjQ0NDktODQxMS00M2Y4LWI5ZWUtMDVhMWZhNGZjMDI4XkEyXkFqcGdeQXVyNTI4MzE4MDU@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/8/8d/Jojo_Rabbit_film.png',
    ...
    reason:'Balances warmth, humour, and genuine heartbreak.',
  },
  {
    id:'fl-15', title:'Fury', year:2014, genre:'War / Action',
    traits:['action','dark','melancholy'], badge:'Brutal War Drama',
    synopsis:'A war-hardened sergeant commands a Sherman tank crew behind enemy lines in Nazi Germany.',
    imageUrl:'https://m.media-amazon.com/images/M/MV5BMjA2NjAzNzMxMV5BMl5BanBnXkFtZTgwMzM3NTM1MjE@._V1_SX300.jpg',
    backdropUrl:'https://upload.wikimedia.org/wikipedia/en/5/5f/Fury_2014_poster.jpg',
